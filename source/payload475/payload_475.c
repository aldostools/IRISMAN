...
{
   // TOC 4.75 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
...
{
   // TOC 4.76 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
   toc =peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.78 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
   toc =peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.81 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.82 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.83 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.84 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.85 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) != 0x323031392F30312FULL); //timestamp: 2019/08/
   }
   else
   {
      return 0;
