...
{
   // TOC 4.75 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
...
{
   // TOC 4.76 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc =peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.78 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc =peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.81 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.82 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.83 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.84 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.85 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.86 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.87 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.88 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.89 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
