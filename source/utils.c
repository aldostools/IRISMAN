...
{
	u32 pid_list[16];
	lv2syscall3(SYSCALL_MAMBA, SYSCALL8_OPCODE_PS3MAPI, PS3MAPI_OPCODE_GET_ALL_PROC_PID, (u64)(u32)pid_list);
	...
	if(pid)
	{
		u32 mod_list[62];
		char tmp_name[30];
		lv2syscall4(SYSCALL_MAMBA, SYSCALL8_OPCODE_PS3MAPI, PS3MAPI_OPCODE_GET_ALL_PROC_MODULE_PID, (u64)pid, (u64)(u32)mod_list);
		...
		for(unsigned int slot = 0; slot <= 10; slot++)
		{
			...
			if(1 < mod_list[slot])
			{
				lv2syscall5(SYSCALL_MAMBA, SYSCALL8_OPCODE_PS3MAPI, PS3MAPI_OPCODE_GET_PROC_MODULE_NAME, (u64)pid, (u64)mod_list[slot], (u64)(u32)tmp_name);
